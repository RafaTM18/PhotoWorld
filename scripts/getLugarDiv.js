function getLugarDiv(lugar, key){
    console.log("\n Lugar: " + JSON.stringify(lugar));
    var nomeLugarText = document.createTextNode(lugar.nome);
        ...
        card.setAttribute("class","card shadow mb-2");
            ...
            cardBody.setAttribute("class", "card-body p-0");
                ...
                divImg.setAttribute("class", "text-center col-sm-12");
                    ...
                    imgLugar.setAttribute("src",lugar.img);
                ...
                divAreaDescricao.setAttribute("class","col-sm-12 text-center");
                    ...
                    divDescricao.setAttribute("class","p-1 text-center");
                        const descricaoText = document.createTextNode(lugar.desc);
                ...
                divTexto.setAttribute("class","col-sm-12 text-center");
                    ...
                    linkMapa.setAttribute("href",lugar.local);
            ...
            cardBody.appendChild(divDescricao);
